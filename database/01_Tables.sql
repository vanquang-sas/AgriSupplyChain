...
CREATE TABLE TONKHO (
    ...
    TGHetHan DATE,
    ViTri NVARCHAR2(100),
    TrangThai NVARCHAR2(50) DEFAULT N'Còn hạn' CHECK (TrangThai IN (N'Còn hạn', N'Sắp hết hạn', N'Hết hạn')),
    CONSTRAINT FK_TK_KHO FOREIGN KEY (MaKho) REFERENCES KHO(MaKho),
    CONSTRAINT FK_TK_CTLH FOREIGN KEY (MaLH, MaSP) REFERENCES CHITIETLOHANG(MaLH, MaSP),
    CONSTRAINT UQ_TK_LH_SP UNIQUE (MaLH, MaSP),
...
CREATE TABLE XUATKHO (
    ...
    CONSTRAINT FK_XK_CTDH FOREIGN KEY (MaDH, MaSP) REFERENCES CHITIETDONHANG(MaDH, MaSP),
