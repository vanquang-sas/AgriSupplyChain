...
public class TaiKhoanDTO {
    ...
    public TaiKhoanDTO(String username, String password, int loaiTK, int trangThaiTK, Date tgTao) {
        this.username = username; this.password = password; this.loaiTK = loaiTK;
        this.trangThaiTK = trangThaiTK; this.tgTao = tgTao;
    }
