...
public class Pagination extends JPanel {
    ...
    // ── Màu ────────────────────────────────────
    private static final Color C_PRIMARY   = ThemeColor.PRIMARY;
    private static final Color C_HOVER_BG  = Color.decode("#F0FDF4");
    private static final Color C_BORDER    = ThemeColor.BORDER;
    private static final Color C_TEXT      = ThemeColor.TEXT_PRIMARY;
    private static final Color C_MUTED     = ThemeColor.TEXT_SECONDARY;
    ...
    private void buildUI() {
        ...
        add(btnNext);
        add(btnLast);
        add(rightPanel);   // push → tự đẩy sang phải
    }
