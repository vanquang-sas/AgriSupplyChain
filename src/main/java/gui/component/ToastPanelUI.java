...
import static gui.component.ToastClientProperties.*;
...
public class ToastPanelUI extends BasicPanelUI implements StyleableUI, PropertyChangeListener {
    ...
    protected void installDefaults(JPanel p) {
        ...
        closeButtonIcon = UIUtils.getIcon(prefix + ".closeIcon", UIUtils.createIcon("icon/close.svg", closeIconColor, 0.75f));
