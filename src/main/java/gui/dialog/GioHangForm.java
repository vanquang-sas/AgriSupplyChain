...
public class GioHangForm extends JDialog {
    ...
    public GioHangForm(MainFrame parent) {
        super(parent, true);
    ...
    // Getter công khai để Form thanh toán truy cập nếu cần
    public MainFrame getParentFrame() { return this.parentFrame; }

    private void initComponents() {
        setSize(1000, 650);
        setLocationRelativeTo(parentFrame);

        // Nền góc tròn chính giữ nguyên
        ...
        lblTitle = new JLabel("CHI TIẾT GIỎ HÀNG");
        ...
        // --- MAIN CONTENT (Khởi tạo vùng Giỏ Hàng ban đầu) ---
        pnlContent = new JPanel(new BorderLayout(20, 0));
        ...
        pnlToolbar.setBorder(new EmptyBorder(0, 0, 15, 0));
        ...
        cbxSort.setPreferredSize(new Dimension(130, 35));
        ...
        btnClearAll.setPreferredSize(new Dimension(90, 35));
        ...
        txtSearch.setPreferredSize(new Dimension(190, 35));
        ...
        pnlToolRight.setBorder(new EmptyBorder(0, 20, 0, 0));
        ...
        btnCheckout.addActionListener(e -> processCheckout()); // Sự kiện ấn đặt hàng
        ...
        mainPanel.add(pnlContent, BorderLayout.CENTER); // Mặc định add Giỏ hàng vào Center
    ...
    private void processCheckout() {
        ...
        // 2. Khởi tạo và hiển thị form thanh toán JDialog (Popup đè lên form hiện tại)
        ThanhToanForm thanhToanForm = new ThanhToanForm(this, this.parentFrame, total);
    ...
    // ================= UTILS CLASS (Giữ nguyên) =================

    class SearchField extends JTextField {
        private final String placeholder;
        public SearchField(String placeholder) { this.placeholder = placeholder; setOpaque(false); }
        @Override
        protected void paintComponent(Graphics g) {
            Graphics2D g2 = (Graphics2D) g.create();
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            g2.setColor(Color.WHITE); g2.fillRoundRect(0, 0, getWidth() - 1, getHeight() - 1, 10, 10);
            g2.setColor(Color.LIGHT_GRAY); g2.drawRoundRect(0, 0, getWidth() - 1, getHeight() - 1, 10, 10);
            g2.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 14)); g2.setColor(Color.GRAY);
    ...
    // CHÚ Ý: Đổi từ private/default sang public class để `ThanhToanForm` dùng ké nút bấm bo góc đẹp này
