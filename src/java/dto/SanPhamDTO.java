...
public class SanPhamDTO {
    ...
    public SanPhamDTO(String maSP, String tenSP, String maLSP, String chatLuong, double giaMua, double giaBan, String donViTinh, String baoQuan, String hinhAnh) {
        this.maSP = maSP; this.tenSP = tenSP; this.maLSP = maLSP; this.chatLuong = chatLuong;
        this.giaMua = giaMua; this.giaBan = giaBan; this.donViTinh = donViTinh; this.baoQuan = baoQuan; this.hinhAnh = hinhAnh;
    }
